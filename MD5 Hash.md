# Algorithm-MD5 Hash
MD5 is a broken (since 2008), but widely used Cryptographic Hash Function with a 128-bit [digest](https://wiki.uncloak.com/Digest). MD5 is vulnerable to collision and length extension attacks.
